...
@return {Promise} Resolves to the response of the network transaction
 ...
 * @throws {module:@zakkudo/fetch/QueryStringError~QueryStringError} On issues during serialization or construction of the query string
 */
